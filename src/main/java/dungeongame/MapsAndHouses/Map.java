...
public class Map extends Bot {
    ...
    public void showMap(Long chatId, int x, int y) {
        ...
        if (x == 0) {
            switch (y) {
                case 0:
                    sendPicture(chatId,"https://db3pap006files.storage.live.com/y4mjN2YYhKB5WaEeYywK2jEDSZyP-o5Fw-uFYktAMDIrbcxBG4C57VH8AzrPMMRl22P6MSMjiLFIQaRnFrEE7npMidbi0wvzugmFmoDYk7zeGcPUv_dY0HYxf1KJMihmKf68B-HeY0FwMxoG7ADst-muoNRHdF6awC89DJYcisrefm5ZabCxE8jQZFZxPejci1R7p9E8fnI2IfGAb5gy3K7WUL48bKBAoOTF7vJoBTUviY?encodeFailures=1&width=327&height=331");
                    break;
                case 1:
                    sendPicture(chatId,"https://db3pap006files.storage.live.com/y4mfRPtsyA-YSLrdf22Nx76Cv76sB_goCzPrcKiYsuLpqeV51qnL2vFMUMpKMS1cVk2UKJ0ukP8-9WGwRGktrbsy4abXu0eTvTc8sWPe_tudarJP3U1C0_9glS1JdioP2xFH91P_5wRui5NTLMKipND1qxrO8erQy2K32Fpj1_NuLr6jWnK963ESd_SAxjoXTj7qbUEGtkQQUOqHRQEDa-DyK0FkMaXCbBX2Vq6xfooqCA?encodeFailures=1&width=327&height=330");
                    break;
                case 2:
                    sendPicture(chatId,"https://db3pap006files.storage.live.com/y4mtUC1h69qWX3MChj5jX75RiFVxyHYdZwAGZ2_tsxFp7GeTZDIEVx3GrW3pNHRPeIe1P98pwKVoZEcyaG9jAPQXkRleyI5axUJoTEdblUlbNpSrsWXopvPVvHl_fOT6pOErifTTHEbW0xN5Yu75l7rY9Bw4_fQOTMtsT8HyM3rdTsdu0PUCnXxcccLSpB4cxyuZJ63exEp9yfBLoKXo0K7tCoR-SCS2srqP6JfrqnhTw0?encodeFailures=1&width=341&height=330");
                    break;
            }
        } else if (x == 1) {
            switch (y) {
                case 0:
                    sendPicture(chatId,"https://db3pap006files.storage.live.com/y4mU6ADmGO_mwdBw1MFKrzUiKkcQpnsZGzNhDzV7Z8aIcOUtLp85UVmq5xTp2SDJ4KVDkLkMybVVVitwzTH9JsR8ZzxlApY-flqka3i_SsKUyF0lQjYzpKTDcfuF__hH42vbm-1d_O-QF0gvZJuWZpiG2_U_OD0lsHuBJzZp-Bxvbue4g3MOYOxSJHyrx4VlLZP6HY7EqtUjSCdqoqkefqL1p1NtjHTquLhPrmigbnXLD4?encodeFailures=1&width=327&height=330");
                    break;
                case 1:
                    sendPicture(chatId,"https://db3pap006files.storage.live.com/y4moTB_Eq9r1jYBGIrSAd8b6eh4fDToVAfDNcANvKpyvCdhHAeaYtTi9iGpEF26jJnAlkVqXqPX5LAkjZEVl1v-0kWYO56N4C6A1vOROybGc2ybMi_LQRs6ZLG5gBBtEauv2P2n2OIai0lewSK6Bz2eMubH5T_WaQ-fFKE8ZbBxa9kcwQ45GUywrS-yRKZQk0-j-PeCxgPJ-gHX2U0s1gd__7RpNrF-w5xtDyWGU4LowKE?encodeFailures=1&width=327&height=330");
                    break;
                case 2:
                    sendPicture(chatId,"https://db3pap006files.storage.live.com/y4mWYYqvrs4zzbsqqOxZO5g3UmAaK9KTUjQDGnHDE1m02I39sIDQAGXPnUkCgjMTgx3ui3XSHxbs0AiuaJ_-nYS1savlRJ9pyudijD8cINYEEK8dFdlF8LWFJNAwxzxfoN7qtOfZU_r6bYp_GpZVXbSeW3WCe5gORnYTmdOOQ77kmIUYs4U7YL_dUlS5agwekygQSZ-nxlaGcEMvoBFN_fxLHP-xSPIJWMgGn0ql0Qkpa4?encodeFailures=1&width=327&height=330");
                    break;
            }
    ...
    public void sendPicture(Long chatID, String PictureURL) {
        ...
        input.setPhoto(new InputFile(PictureURL));
        try {
            execute(input);
